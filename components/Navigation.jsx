...
const Navigation = () => {
  ...
  return (
    <aside className="bg-primary py-12  md:p-5 pr-0   text-white">
      <a
        href=""
        className="hidden md:flex mb-6 mt-4 text-center justify-center mr-2 gap-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      <nav className="sticky top-3">
        {links.map((link) => (
             ...
             <span className={pathname === link.url ? activeClasses : inactiveClasses}>
               {link.icon}
